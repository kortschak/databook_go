<!-- Code generated by `gd -o CH02_SEC02_3_SpectralDerivative.md CH02_SEC02_3_SpectralDerivative.go`; DO NOT EDIT. -->
```
...
```
	{
		...
		show.PNG(c.Image(), "", "")
```
> ![](CH02_SEC02_3_SpectralDerivative_77.png)
```
	}
```
...
```
	{
		...
		show.PNG(c.Image(), "", "")
```
> ![](CH02_SEC02_3_SpectralDerivative_128.png)
```
	}
}
